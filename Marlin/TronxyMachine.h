...
#define TRONXY_UI          UI_MARLIN_DEFAULT  // UI_SIM480X320
...
#define INVERT_E0_DIR             false //TITAN:true,true; BMG:false,true // using left and right versions of a dual drive extruder (BMG)
